...
print(email[2:]) #[start:] from a specified starting index until the end. STARTING POSITION IS NOT PRINTED
print(email[:13]) #[:end] from the start of a string until a specified end. ENDING POSITION IS ALSO PRINTED
